...
public class CalculatorController {
    ...
    /**
     * Логическая переменная для определения возмо;ности доступа к вычеслениям на основании выобора соответствующего варианта в менью
     */
